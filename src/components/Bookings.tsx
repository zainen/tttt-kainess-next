  ...
  return (
    <div className="w-full pb-4">
      <div className="flex flex-row items-center justify-center pb-4 md">
        <Image className='w-1/2 object-cover object-center max-h-80 p-2' width={300} height={300} src="/img/wellness-plan.jpeg" alt="wellness plan"/>
      ...
      <div className="flex flex-row items-center justify-center">
        <Image className='w-1/2 object-cover object-center max-h-80 p-2' width={300} height={300} src="/img/healthy-eating.jpeg" alt="blank recipe card"/>
        <Card rounded={false} className="h-fit w-80 sm:-translate-x-20 bg-primary-100 text-primary-400 p-8 md:p-12" >
